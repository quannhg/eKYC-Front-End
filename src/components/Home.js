            ...
            <Col>
                ...
                <Row className='main m-0 mw-100 d-flex justify-content-between align-items-center'>
                    <Col style={{marginLeft:'6.3rem'}} xs={5}>
                        ...
                        <Row className="sm-5 d-grid gap-2 mt-5">
                            <Link to="./feature1" className='p-0 m-0'>
                                ...
                                >
                                    <div className="mw-100" style={{ textAlign: 'left', padding: "0px 50px" }}>
                            ...
                            <Link to="./feature1" className='p-0 m-0'>
                                <Button size="lg" className="custom-button" style={{ backgroundColor: "#00ADC6", border: "0px" }}>
                                    <div style={{ width: '554.4px', textAlign: 'left', padding: "0px 50px" }}>
                    ...
                    <Col className="m-0 p-0" xs={6}>
                        <Image className="m-0 p-0" height="455rem" src="/images/facial-recognition.jpg" rounded />
                    </Col>
                </Row>
            </Col>
        </Container>
